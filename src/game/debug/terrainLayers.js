export const terrainLayers = {
  groves: { label: '树群密度', legend: '环境 v2 · 浅色为空地，深绿为树群；实际放置仍检查坡度、聚落与开场净空' },
  finalHeight: { label: '最终高度', legend: '32 m 采样 · 含聚落与开场整地；细小区域请结合整地范围查看' },
...
const ramps = {
  groves: [[0, [168, 157, 108]], [0.4, [94, 131, 76]], [1, [28, 73, 48]]],
